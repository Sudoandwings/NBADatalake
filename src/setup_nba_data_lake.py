...
import time
import requests
from dotenv import load_dotenv # Do not use with Cloudshell
import os # Do not use with Cloudshell

# Load environment variables from .env file # Do not use with Cloudshell
load_dotenv()
...
api_key = os.getenv("SPORTS_DATA_API_KEY")  # Get API key from .env # Replace with just the key in quotes if on Cloudshell
nba_endpoint = os.getenv("NBA_ENDPOINT")  # Get NBA endpoint from .env # Replace with just the key in quotes if on Cloudshell
